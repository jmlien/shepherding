...
protected:
    ...
    virtual void derive(list<CFlockState*>& states);
    virtual void solveODE(list<CFlockState*>& states, float step);
    ...
    //////////////////////////////////////////////////////////////////////
    //Resolve Collision
    void applyFlockStateCollisions(list<CFlockState*>& states);
